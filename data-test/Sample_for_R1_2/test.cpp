...
int testLoopFor(int n, int m)
{
    for (int i=1; i<=n; i++)
        for (int j=1; j<=m; j++)
        if(n==5 && m==6) return m+n;
      return 0;
}
int testLoopFor1(int n)
{
    for (int i=1; i<=n; i++)
...
char  MathEnglishGradechar (char Math, char English)
{
//Loi ta cac truong hop Math=50, math=80, English=60, English=90
	//if(Math>=50 && English>=60)
	if(Math>50 && English>60)
...
char  MathEnglishGradeshort (short Math, short English)
{
//Loi ta cac truong hop Math=50, math=80, English=60, English=90
	//if(Math>=50 && English>=60)
	if(Math>50 && English>60)
...
char  MathEnglishGradeUnsignedShort (unsigned short Math, unsigned short English)
{
//Loi ta cac truong hop Math=50, math=80, English=60, English=90
	//if(Math>=50 && English>=60)
	if(Math>50 && English>60)
...
char  MathEnglishGradelong (long Math, long English)
{
//Loi ta cac truong hop Math=50, math=80, English=60, English=90
	//if(Math>=50 && English>=60)
	if(Math>50 && English>60)
...
double testBoundDouble(double x)
{
	if(x>5.0 && x<1.0) return 1.0;
	return 0;
}

float testBoundFloat(float x)
{
	if(x>15.0 && x<8.0) return 1.0;
	return 0;
}
