...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase19.tp"
...
void UET_TEST_TestCase19(void) {
try {
{
UET_test_case_name="TestCase19";
long e = 2147483647;long a = -1073741824;long b = 1073741824;long c = -1073741822;long d = 0;
UET_mark("<<PRE-CALLING>> Test TestCase19");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE19", &UET_TEST_TestCase19, 1);
