...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase5.tp"
...
void UET_TEST_TestCase5(void) {
try {
{
UET_test_case_name="TestCase5";
long a = 2147483647;long b = 1073741824;long c = -1073741822;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase5");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE5", &UET_TEST_TestCase5, 1);
