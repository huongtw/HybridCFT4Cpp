...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase11.tp"
...
void UET_TEST_TestCase11(void) {
try {
{
UET_test_case_name="TestCase11";
long c = -2147483648;long a = -1073741824;long b = 1073741824;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase11");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE11", &UET_TEST_TestCase11, 1);
