...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase14.tp"
...
void UET_TEST_TestCase14(void) {
try {
{
UET_test_case_name="TestCase14";
long c = 4.0;long a = -1073741824;long b = 1073741824;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase14");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE14", &UET_TEST_TestCase14, 1);
