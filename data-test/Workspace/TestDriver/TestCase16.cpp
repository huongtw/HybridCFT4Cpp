...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase16.tp"
...
void UET_TEST_TestCase16(void) {
try {
{
UET_test_case_name="TestCase16";
long d = -2147483648;long a = -1073741824;long b = 1073741824;long c = -1073741822;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase16");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE16", &UET_TEST_TestCase16, 1);
