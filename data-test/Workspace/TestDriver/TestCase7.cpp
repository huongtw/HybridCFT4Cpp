...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase7.tp"
...
void UET_TEST_TestCase7(void) {
try {
{
UET_test_case_name="TestCase7";
long b = 1.0;long a = -1073741824;long c = -1073741822;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase7");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE7", &UET_TEST_TestCase7, 1);
