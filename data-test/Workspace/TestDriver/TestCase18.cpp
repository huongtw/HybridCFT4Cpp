...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase18.tp"
...
#include "D:\Tool_VNU\data-test\Workspace\InstrumentedCode\test.uetignore.cpp"
...
void UET_TEST_TestCase18(void) {
try {
{
UET_test_case_name="TestCase18";
long e = -2147483648;long a = -1073741824;long b = 1073741824;long c = -1073741822;long d = 0;
UET_mark("<<PRE-CALLING>> Test TestCase18");MoreComplexCond(a,b,c,d,e);
UET_fCall++;UET_mark("Return from: D:\\Tool_VNU\\data-test\\Sample_for_R1_2\\test.cpp\\MoreComplexCond(long,long,long,long,long)");
}
} catch (std::exception& error) {
UET_mark("Phat hien loi runtime");
}
}
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE18", &UET_TEST_TestCase18, 1);
