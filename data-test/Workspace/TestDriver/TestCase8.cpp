...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase8.tp"
...
void UET_TEST_TestCase8(void) {
try {
{
UET_test_case_name="TestCase8";
long b = 2.0;long a = -1073741824;long c = -1073741822;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase8");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE8", &UET_TEST_TestCase8, 1);
