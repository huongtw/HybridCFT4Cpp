...
#define UET_TEST_PATH_FILE "D:\\Tool_VNU\\data-test\\Workspace\\Testpath\\TestCase13.tp"
...
void UET_TEST_TestCase13(void) {
try {
{
UET_test_case_name="TestCase13";
long c = 3.0;long a = -1073741824;long b = 1073741824;long d = 0;long e = 0;
UET_mark("<<PRE-CALLING>> Test TestCase13");MoreComplexCond(a,b,c,d,e);
...
int main(int argc, char *argv[])
{
    ...
    /* add & run the tests */
    	UET_run_test("TESTCASE13", &UET_TEST_TestCase13, 1);
