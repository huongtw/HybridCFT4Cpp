...
public class FullBoundedTestGen
{
    ...
    private double boundStep = 1;  //Thay doi gia tri quanh bien
    ...
    public void boundaryValueTestGen() throws Exception
    {
        ...
        List<TestData> boundTestDataList = Utils.generateTestpathsForBoundaryTestGen(cfg, function.getPassingVariables(), this.boundStep);
