...
public class HybridAutoTestGen extends Application {
    ...
    private float boundStep = 1; // gan gia tri bien
    ...
    public void generateTestData(double boundStep) throws Exception {
...
//
//        this.cfg = (CFG) cfgGen2.generateCFG();
//
...
//        this.cfg = function.generateCFG();

//        this.cfg.setFunctionNode(function);
//        this.cfg.resetVisitedStateOfNodes();
//        this.cfg.setIdforAllNodes();
        this.maxIterationsforEachLoop = maxloop;
        this.variables = function.getArguments();
...
//                this.function, sourceFolder);
        ...
        graph = new Graph(LocalDateTime.now(), cfg, tpGen.getPossibleTestpaths(), (IFunctionNode) this.function, sourceFolder, 1);
        graph.setEpoches(1);
        graph.addConstraint();
        WeightedCFGTestGEn Prob = new WeightedCFGTestGEn(this.functionName, 1, this.sourceFolder);
        Prob.setFunctionNode((IFunctionNode) this.function);
        ...
        do {
//            FullTestpath testpath = (FullTestpath) this.getPossibleTestpaths().get(pathNumber);
            FullTestpath testpath = (FullTestpath) tpGen.getPossibleTestpaths().get(pathNumber);
...
//            String testcase = tpclone.getTestCase().replaceAll(";;", ";");
            ...
            String testcase = Prob.getSolutionInRandomPath(graph, pathNumber);
...
//            }
            ...
            graph.updateGraph(pathNumber, 1, hmmGraph, 1);
            trackedPath.setTestCase(testcase);
            pathNumber = graph.getNewPath();
