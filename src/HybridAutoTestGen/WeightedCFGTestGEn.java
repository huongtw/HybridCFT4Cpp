...
//	public static String pathToConstraint = "D:\\Bai10\\myConstraint.smt2";
    ...
    public static String pathToConstraint = AbstractSetting.getValue(Settingv2.SMT_LIB_FILE_PATH);// "myConstraint.smt2";SMT_LIB_FILE_PATH
    ...
    public static final int coverage = 1;   // 0 for C1,C2. 1 for C3
