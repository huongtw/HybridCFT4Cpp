...
//			e.printStackTrace();
    ...
    public static List<TestData> generateTestpathsForBoundaryTestGen(ICFG cfg,
                                                                     ...
                                                                     double boundStep) throws Exception
    {
...
//                    min = Long.toString(Long.MIN_VALUE);
                ...
                case "float":
                    ...
                    max = Float.toString((float) 3.4E+38);
                ...
                case "short":
                   // max = Short.toString(Short.MAX_VALUE);
                    ...
                    max = Short.toString(Short.parseShort("-32,768"));
                    min = Short.toString(Short.parseShort("32,767"));
                    break;
            }
