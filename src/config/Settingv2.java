...
public class Settingv2 extends AbstractSetting {
	...
	public static void initialWindowOS_forDevelopment() {
		...
		getAttributes().put(GNU_GCC_PATH, "C:/MinGW/bin/gcc.exe");
		getAttributes().put(GNU_GPlusPlus_NAME, "g++.exe");
		getAttributes().put(GNU_GPlusPlus_PATH, "C:/MinGW/bin/g++.exe");
		getAttributes().put(GNU_GENERAL, "C:\\MinGW\\bin");
		getAttributes().put(GNU_MAKE_NAME, "mingw32-make.exe");
		getAttributes().put(GNU_MAKE_PATH, "C:/MinGW/bin/mingw32-make.exe");
